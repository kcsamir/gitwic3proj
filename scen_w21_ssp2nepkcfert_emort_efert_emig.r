{#setup
  ...
  #IN this scenario, we will change the SSP2 fertility for Nepal and 
  ...
  iscen = "w21ssp2nepkcfert" #s for ssps 
  ...
  newferttype = "kcfert" # 0 15-19 asfr and -90% decline in asfr
